...
const (
	...
	// JSConsumerReplicasShouldMatchStream consumer config replicas needs to match interest retention stream's replicas
...
var (
	ApiErrors = map[ErrorIdentifier]*ApiError{
		...
		JSConsumerReplicasShouldMatchStream:        {Code: 400, ErrCode: 10134, Description: "consumer config replicas needs to match interest retention stream's replicas"},
...
// NewJSConsumerReplicasShouldMatchStreamError creates a new JSConsumerReplicasShouldMatchStream error: "consumer config replicas needs to match interest retention stream's replicas"
